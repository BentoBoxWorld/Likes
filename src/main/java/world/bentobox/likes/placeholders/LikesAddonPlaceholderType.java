...
{
// ---------------------------------------------------------------------
// Section: Island Placeholders
// ---------------------------------------------------------------------

    /**
     * This placeholder returns likes that is set for given island.
     */
    ISLAND_LIKES("island_likes_count", (addon, gameModeAddon, user) ->
    {
     ...
     */
    ISLAND_LIKES_PLACE("island_likes_place", (addon, gameModeAddon, user) ->
    {
        Island island = gameModeAddon.getIslands().getIsland(gameModeAddon.getOverWorld(), user);
        return island != null ?
     ...
     */
    ISLAND_DISLIKES("island_dislikes_count", (addon, gameModeAddon, user) ->
    {
        Island island = gameModeAddon.getIslands().getIsland(gameModeAddon.getOverWorld(), user);
        return island != null ?
     ...
     */
    ISLAND_DISLIKES_PLACE("island_dislikes_place", (addon, gameModeAddon, user) ->
    {
        Island island = gameModeAddon.getIslands().getIsland(gameModeAddon.getOverWorld(), user);
        return island != null ?
     ...
     */
    ISLAND_RANK("island_rank_count", (addon, gameModeAddon, user) ->
    {
        Island island = gameModeAddon.getIslands().getIsland(gameModeAddon.getOverWorld(), user);
        return island != null ?
     ...
     */
    ISLAND_RANK_PLACE("island_rank_place", (addon, gameModeAddon, user) ->
    {
        Island island = gameModeAddon.getIslands().getIsland(gameModeAddon.getOverWorld(), user);
        return island != null ?
    ...
    /**
     * This placeholder returns stars that is set for given island.
     */
    ISLAND_STARS("island_stars_value", (addon, gameModeAddon, user) ->
    {
        Island island = gameModeAddon.getIslands().getIsland(gameModeAddon.getOverWorld(), user);
        return island != null ?
    ...
    /**
     * This placeholder returns island rank placement by their star count.
     */
    ISLAND_STARS_PLACE("island_stars_place", (addon, gameModeAddon, user) ->
    {
        Island island = gameModeAddon.getIslands().getIsland(gameModeAddon.getOverWorld(), user);
        return island != null ?
...
// ---------------------------------------------------------------------
// Section: Visited Island Placeholders
// ---------------------------------------------------------------------

    /**
     * This placeholder returns visited likes that is set for given island.
     */
    VISITED_ISLAND_LIKES("visited_island_likes_count", (addon, gameModeAddon, user) ->
    {
    ...
    /**
     * This placeholder returns visited island rank placement by their like count.
     */
    VISITED_ISLAND_LIKES_PLACE("visited_island_likes_place", (addon, gameModeAddon, user) ->
    {
        Island island = gameModeAddon.getIslands().getIslandAt(user.getLocation()).orElse(null);
        return island != null ?
            String.valueOf(addon.getAddonManager().getIslandRankByLikes(
    ...
    /**
     * This placeholder returns visited dislikes that is set for given island.
     */
    VISITED_ISLAND_DISLIKES("visited_island_dislikes_count", (addon, gameModeAddon, user) ->
    {
        Island island = gameModeAddon.getIslands().getIslandAt(user.getLocation()).orElse(null);
        return island != null ?
            String.valueOf(LikesAddonPlaceholderType.getObject(addon, gameModeAddon, island).getDislikes()) : "";
    ...
    /**
     * This placeholder returns visited island rank placement by their dislike count.
     */
    VISITED_ISLAND_DISLIKES_PLACE("visited_island_dislikes_place", (addon, gameModeAddon, user) ->
    {
        Island island = gameModeAddon.getIslands().getIslandAt(user.getLocation()).orElse(null);
        return island != null ?
            String.valueOf(addon.getAddonManager().getIslandRankByDislikes(
    ...
    /**
     * This placeholder returns visited rank that is set for given island.
     */
    VISITED_ISLAND_RANK("visited_island_rank_count", (addon, gameModeAddon, user) ->
    {
        Island island = gameModeAddon.getIslands().getIslandAt(user.getLocation()).orElse(null);
        return island != null ?
            String.valueOf(LikesAddonPlaceholderType.getObject(addon, gameModeAddon, island).getRank()) : "";
    ...
    /**
     * This placeholder returns visited island rank placement by their rank count.
     */
    VISITED_ISLAND_RANK_PLACE("visited_island_rank_place", (addon, gameModeAddon, user) ->
    {
        Island island = gameModeAddon.getIslands().getIslandAt(user.getLocation()).orElse(null);
        return island != null ?
            String.valueOf(addon.getAddonManager().getIslandRankByRank(
    ...
    /**
     * This placeholder returns visited star that is set for given island.
     */
    VISITED_ISLAND_STARS("visited_island_stars_value", (addon, gameModeAddon, user) ->
    {
        Island island = gameModeAddon.getIslands().getIslandAt(user.getLocation()).orElse(null);
        return island != null ?
            String.valueOf(LikesAddonPlaceholderType.getObject(addon, gameModeAddon, island).getStarsValue()) : "";
    ...
    /**
     * This placeholder returns visited island rank placement by their star count.
     */
    VISITED_ISLAND_STARS_PLACE("visited_island_stars_place", (addon, gameModeAddon, user) ->
    {
        Island island = gameModeAddon.getIslands().getIslandAt(user.getLocation()).orElse(null);
        return island != null ?
            String.valueOf(addon.getAddonManager().getIslandRankByStars(
...
// ---------------------------------------------------------------------
     ...
     */
    BY_LIKES_OWNER_NAME_1("top_likes_owner_name_1", (addon, gameModeAddon, user) ->
    {
     ...
     */
    BY_LIKES_ISLAND_NAME_1("top_likes_island_name_1", (addon, gameModeAddon, user) ->
    {
        LikesObject object = LikesAddonPlaceholderType.getSortedLikes(addon, gameModeAddon).exact(0);
     ...
     */
    BY_LIKES_COUNT_1("top_likes_count_1", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedLikes(addon, gameModeAddon).exact(0);
     ...
     */
    BY_LIKES_OWNER_NAME_2("top_likes_owner_name_2", (addon, gameModeAddon, user) -> {
     ...
     */
    BY_LIKES_ISLAND_NAME_2("top_likes_island_name_2", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedLikes(addon, gameModeAddon).exact(1);
     ...
     */
    BY_LIKES_COUNT_2("top_likes_count_2", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedLikes(addon, gameModeAddon).exact(1);
        return object != null ? String.valueOf(object.getLikes()) : "";
    }),
     ...
     */
    BY_LIKES_OWNER_NAME_3("top_likes_owner_name_3", (addon, gameModeAddon, user) -> {
     ...
     */
    BY_LIKES_ISLAND_NAME_3("top_likes_island_name_3", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedLikes(addon, gameModeAddon).exact(2);
     ...
     */
    BY_LIKES_COUNT_3("top_likes_count_3", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedLikes(addon, gameModeAddon).exact(2);
        return object != null ? String.valueOf(object.getLikes()) : "";
    }),
     ...
     */
    BY_LIKES_OWNER_NAME_4("top_likes_owner_name_4", (addon, gameModeAddon, user) -> {
     ...
     */
    BY_LIKES_ISLAND_NAME_4("top_likes_island_name_4", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedLikes(addon, gameModeAddon).exact(3);
     ...
     */
    BY_LIKES_COUNT_4("top_likes_count_4", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedLikes(addon, gameModeAddon).exact(3);
        return object != null ? String.valueOf(object.getLikes()) : "";
    }),
     ...
     */
    BY_LIKES_OWNER_NAME_5("top_likes_owner_name_5", (addon, gameModeAddon, user) -> {
     ...
     */
    BY_LIKES_ISLAND_NAME_5("top_likes_island_name_5", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedLikes(addon, gameModeAddon).exact(4);
     ...
     */
    BY_LIKES_COUNT_5("top_likes_count_5", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedLikes(addon, gameModeAddon).exact(4);
        return object != null ? String.valueOf(object.getLikes()) : "";
    }),
     ...
     */
    BY_LIKES_OWNER_NAME_6("top_likes_owner_name_6", (addon, gameModeAddon, user) -> {
     ...
     */
    BY_LIKES_ISLAND_NAME_6("top_likes_island_name_6", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedLikes(addon, gameModeAddon).exact(5);
     ...
     */
    BY_LIKES_COUNT_6("top_likes_count_6", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedLikes(addon, gameModeAddon).exact(5);
        return object != null ? String.valueOf(object.getLikes()) : "";
    }),
     ...
     */
    BY_LIKES_OWNER_NAME_7("top_likes_owner_name_7", (addon, gameModeAddon, user) -> {
     ...
     */
    BY_LIKES_ISLAND_NAME_7("top_likes_island_name_7", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedLikes(addon, gameModeAddon).exact(6);
     ...
     */
    BY_LIKES_COUNT_7("top_likes_count_7", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedLikes(addon, gameModeAddon).exact(6);
        return object != null ? String.valueOf(object.getLikes()) : "";
    }),
     ...
     */
    BY_LIKES_OWNER_NAME_8("top_likes_owner_name_8", (addon, gameModeAddon, user) -> {
     ...
     */
    BY_LIKES_ISLAND_NAME_8("top_likes_island_name_8", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedLikes(addon, gameModeAddon).exact(7);
     ...
     */
    BY_LIKES_COUNT_8("top_likes_count_8", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedLikes(addon, gameModeAddon).exact(7);
        return object != null ? String.valueOf(object.getLikes()) : "";
    }),
     ...
     */
    BY_LIKES_OWNER_NAME_9("top_likes_owner_name_9", (addon, gameModeAddon, user) -> {
     ...
     */
    BY_LIKES_ISLAND_NAME_9("top_likes_island_name_9", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedLikes(addon, gameModeAddon).exact(8);
     ...
     */
    BY_LIKES_COUNT_9("top_likes_count_9", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedLikes(addon, gameModeAddon).exact(8);
        return object != null ? String.valueOf(object.getLikes()) : "";
    }),
     ...
     */
    BY_LIKES_OWNER_NAME_10("top_likes_owner_name_10", (addon, gameModeAddon, user) -> {
     ...
     */
    BY_LIKES_ISLAND_NAME_10("top_likes_island_name_10", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedLikes(addon, gameModeAddon).exact(9);
     ...
     */
    BY_LIKES_COUNT_10("top_likes_count_10", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedLikes(addon, gameModeAddon).exact(9);
        return object != null ? String.valueOf(object.getLikes()) : "";
    }),
...
// ---------------------------------------------------------------------
     ...
     */
    BY_DISLIKES_OWNER_NAME_1("top_dislikes_owner_name_1", (addon, gameModeAddon, user) -> {
     ...
     */
    BY_DISLIKES_ISLAND_NAME_1("top_dislikes_island_name_1", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedDislikes(addon, gameModeAddon).exact(0);
     ...
     */
    BY_DISLIKES_COUNT_1("top_dislikes_count_1", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedDislikes(addon, gameModeAddon).exact(0);
     ...
     */
    BY_DISLIKES_OWNER_NAME_2("top_dislikes_owner_name_2", (addon, gameModeAddon, user) -> {
     ...
     */
    BY_DISLIKES_ISLAND_NAME_2("top_dislikes_island_name_2", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedDislikes(addon, gameModeAddon).exact(1);
     ...
     */
    BY_DISLIKES_COUNT_2("top_dislikes_count_2", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedDislikes(addon, gameModeAddon).exact(1);
        return object != null ? String.valueOf(object.getDislikes()) : "";
    }),
     ...
     */
    BY_DISLIKES_OWNER_NAME_3("top_dislikes_owner_name_3", (addon, gameModeAddon, user) -> {
     ...
     */
    BY_DISLIKES_ISLAND_NAME_3("top_dislikes_island_name_3", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedDislikes(addon, gameModeAddon).exact(2);
     ...
     */
    BY_DISLIKES_COUNT_3("top_dislikes_count_3", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedDislikes(addon, gameModeAddon).exact(2);
        return object != null ? String.valueOf(object.getDislikes()) : "";
    }),
     ...
     */
    BY_DISLIKES_OWNER_NAME_4("top_dislikes_owner_name_4", (addon, gameModeAddon, user) -> {
     ...
     */
    BY_DISLIKES_ISLAND_NAME_4("top_dislikes_island_name_4", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedDislikes(addon, gameModeAddon).exact(3);
     ...
     */
    BY_DISLIKES_COUNT_4("top_dislikes_count_4", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedDislikes(addon, gameModeAddon).exact(3);
        return object != null ? String.valueOf(object.getDislikes()) : "";
    }),
     ...
     */
    BY_DISLIKES_OWNER_NAME_5("top_dislikes_owner_name_5", (addon, gameModeAddon, user) -> {
     ...
     */
    BY_DISLIKES_ISLAND_NAME_5("top_dislikes_island_name_5", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedDislikes(addon, gameModeAddon).exact(4);
     ...
     */
    BY_DISLIKES_COUNT_5("top_dislikes_count_5", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedDislikes(addon, gameModeAddon).exact(4);
        return object != null ? String.valueOf(object.getDislikes()) : "";
    }),
     ...
     */
    BY_DISLIKES_OWNER_NAME_6("top_dislikes_owner_name_6", (addon, gameModeAddon, user) -> {
     ...
     */
    BY_DISLIKES_ISLAND_NAME_6("top_dislikes_island_name_6", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedDislikes(addon, gameModeAddon).exact(5);
     ...
     */
    BY_DISLIKES_COUNT_6("top_dislikes_count_6", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedDislikes(addon, gameModeAddon).exact(5);
        return object != null ? String.valueOf(object.getDislikes()) : "";
    }),
     ...
     */
    BY_DISLIKES_OWNER_NAME_7("top_dislikes_owner_name_7", (addon, gameModeAddon, user) -> {
     ...
     */
    BY_DISLIKES_ISLAND_NAME_7("top_dislikes_island_name_7", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedDislikes(addon, gameModeAddon).exact(6);
     ...
     */
    BY_DISLIKES_COUNT_7("top_dislikes_count_7", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedDislikes(addon, gameModeAddon).exact(6);
        return object != null ? String.valueOf(object.getDislikes()) : "";
    }),
     ...
     */
    BY_DISLIKES_OWNER_NAME_8("top_dislikes_owner_name_8", (addon, gameModeAddon, user) -> {
     ...
     */
    BY_DISLIKES_ISLAND_NAME_8("top_dislikes_island_name_8", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedDislikes(addon, gameModeAddon).exact(7);
     ...
     */
    BY_DISLIKES_COUNT_8("top_dislikes_count_8", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedDislikes(addon, gameModeAddon).exact(7);
        return object != null ? String.valueOf(object.getDislikes()) : "";
    }),
     ...
     */
    BY_DISLIKES_OWNER_NAME_9("top_dislikes_owner_name_9", (addon, gameModeAddon, user) -> {
     ...
     */
    BY_DISLIKES_ISLAND_NAME_9("top_dislikes_island_name_9", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedDislikes(addon, gameModeAddon).exact(8);
     ...
     */
    BY_DISLIKES_COUNT_9("top_dislikes_count_9", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedDislikes(addon, gameModeAddon).exact(8);
        return object != null ? String.valueOf(object.getDislikes()) : "";
    }),
     ...
     */
    BY_DISLIKES_OWNER_NAME_10("top_dislikes_owner_name_10", (addon, gameModeAddon, user) -> {
     ...
     */
    BY_DISLIKES_ISLAND_NAME_10("top_dislikes_island_name_10", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedDislikes(addon, gameModeAddon).exact(9);
     ...
     */
    BY_DISLIKES_COUNT_10("top_dislikes_count_10", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedDislikes(addon, gameModeAddon).exact(9);
        return object != null ? String.valueOf(object.getDislikes()) : "";
    }),
...
// ---------------------------------------------------------------------
     ...
     */
    BY_RANK_OWNER_NAME_1("top_rank_owner_name_1", (addon, gameModeAddon, user) -> {
     ...
     */
    BY_RANK_ISLAND_NAME_1("top_rank_island_name_1", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedRank(addon, gameModeAddon).exact(0);
     ...
     */
    BY_RANK_COUNT_1("top_rank_count_1", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedRank(addon, gameModeAddon).exact(0);
     ...
     */
    BY_RANK_OWNER_NAME_2("top_rank_owner_name_2", (addon, gameModeAddon, user) -> {
     ...
     */
    BY_RANK_ISLAND_NAME_2("top_rank_island_name_2", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedRank(addon, gameModeAddon).exact(1);
     ...
     */
    BY_RANK_COUNT_2("top_rank_count_2", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedRank(addon, gameModeAddon).exact(1);
        return object != null ? String.valueOf(object.getRank()) : "";
    }),
     ...
     */
    BY_RANK_OWNER_NAME_3("top_rank_owner_name_3", (addon, gameModeAddon, user) -> {
     ...
     */
    BY_RANK_ISLAND_NAME_3("top_rank_island_name_3", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedRank(addon, gameModeAddon).exact(2);
     ...
     */
    BY_RANK_COUNT_3("top_rank_count_3", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedRank(addon, gameModeAddon).exact(2);
        return object != null ? String.valueOf(object.getRank()) : "";
    }),
     ...
     */
    BY_RANK_OWNER_NAME_4("top_rank_owner_name_4", (addon, gameModeAddon, user) -> {
     ...
     */
    BY_RANK_ISLAND_NAME_4("top_rank_island_name_4", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedRank(addon, gameModeAddon).exact(3);
     ...
     */
    BY_RANK_COUNT_4("top_rank_count_4", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedRank(addon, gameModeAddon).exact(3);
        return object != null ? String.valueOf(object.getRank()) : "";
    }),
     ...
     */
    BY_RANK_OWNER_NAME_5("top_rank_owner_name_5", (addon, gameModeAddon, user) -> {
     ...
     */
    BY_RANK_ISLAND_NAME_5("top_rank_island_name_5", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedRank(addon, gameModeAddon).exact(4);
     ...
     */
    BY_RANK_COUNT_5("top_rank_count_5", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedRank(addon, gameModeAddon).exact(4);
        return object != null ? String.valueOf(object.getRank()) : "";
    }),
     ...
     */
    BY_RANK_OWNER_NAME_6("top_rank_owner_name_6", (addon, gameModeAddon, user) -> {
     ...
     */
    BY_RANK_ISLAND_NAME_6("top_rank_island_name_6", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedRank(addon, gameModeAddon).exact(5);
     ...
     */
    BY_RANK_COUNT_6("top_rank_count_6", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedRank(addon, gameModeAddon).exact(5);
        return object != null ? String.valueOf(object.getRank()) : "";
    }),
     ...
     */
    BY_RANK_OWNER_NAME_7("top_rank_owner_name_7", (addon, gameModeAddon, user) -> {
     ...
     */
    BY_RANK_ISLAND_NAME_7("top_rank_island_name_7", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedRank(addon, gameModeAddon).exact(6);
     ...
     */
    BY_RANK_COUNT_7("top_rank_count_7", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedRank(addon, gameModeAddon).exact(6);
        return object != null ? String.valueOf(object.getRank()) : "";
    }),
     ...
     */
    BY_RANK_OWNER_NAME_8("top_rank_owner_name_8", (addon, gameModeAddon, user) -> {
     ...
     */
    BY_RANK_ISLAND_NAME_8("top_rank_island_name_8", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedRank(addon, gameModeAddon).exact(7);
     ...
     */
    BY_RANK_COUNT_8("top_rank_count_8", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedRank(addon, gameModeAddon).exact(7);
        return object != null ? String.valueOf(object.getRank()) : "";
    }),
     ...
     */
    BY_RANK_OWNER_NAME_9("top_rank_owner_name_9", (addon, gameModeAddon, user) -> {
     ...
     */
    BY_RANK_ISLAND_NAME_9("top_rank_island_name_9", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedRank(addon, gameModeAddon).exact(8);
     ...
     */
    BY_RANK_COUNT_9("top_rank_count_9", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedRank(addon, gameModeAddon).exact(8);
        return object != null ? String.valueOf(object.getRank()) : "";
    }),
     ...
     */
    BY_RANK_OWNER_NAME_10("top_rank_owner_name_10", (addon, gameModeAddon, user) -> {
     ...
     */
    BY_RANK_ISLAND_NAME_10("top_rank_island_name_10", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedRank(addon, gameModeAddon).exact(9);
     ...
     */
    BY_RANK_COUNT_10("top_rank_count_10", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedRank(addon, gameModeAddon).exact(9);
        return object != null ? String.valueOf(object.getRank()) : "";
    }),
...
// ---------------------------------------------------------------------
     ...
     */
    BY_STARS_OWNER_NAME_1("top_stars_owner_name_1", (addon, gameModeAddon, user) -> {
     ...
     */
    BY_STARS_ISLAND_NAME_1("top_stars_island_name_1", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedStars(addon, gameModeAddon).exact(0);
     ...
     */
    BY_STARS_COUNT_1("top_stars_count_1", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedStars(addon, gameModeAddon).exact(0);
     ...
     */
    BY_STARS_OWNER_NAME_2("top_stars_owner_name_2", (addon, gameModeAddon, user) -> {
     ...
     */
    BY_STARS_ISLAND_NAME_2("top_stars_island_name_2", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedStars(addon, gameModeAddon).exact(1);
     ...
     */
    BY_STARS_COUNT_2("top_stars_count_2", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedStars(addon, gameModeAddon).exact(1);
        return object != null ? String.valueOf(object.getStarsValue()) : "";
    }),
     ...
     */
    BY_STARS_OWNER_NAME_3("top_stars_owner_name_3", (addon, gameModeAddon, user) -> {
     ...
     */
    BY_STARS_ISLAND_NAME_3("top_stars_island_name_3", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedStars(addon, gameModeAddon).exact(2);
     ...
     */
    BY_STARS_COUNT_3("top_stars_count_3", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedStars(addon, gameModeAddon).exact(2);
        return object != null ? String.valueOf(object.getStarsValue()) : "";
    }),
     ...
     */
    BY_STARS_OWNER_NAME_4("top_stars_owner_name_4", (addon, gameModeAddon, user) -> {
     ...
     */
    BY_STARS_ISLAND_NAME_4("top_stars_island_name_4", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedStars(addon, gameModeAddon).exact(3);
     ...
     */
    BY_STARS_COUNT_4("top_stars_count_4", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedStars(addon, gameModeAddon).exact(3);
        return object != null ? String.valueOf(object.getStarsValue()) : "";
    }),
     ...
     */
    BY_STARS_OWNER_NAME_5("top_stars_owner_name_5", (addon, gameModeAddon, user) -> {
     ...
     */
    BY_STARS_ISLAND_NAME_5("top_stars_island_name_5", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedStars(addon, gameModeAddon).exact(4);
     ...
     */
    BY_STARS_COUNT_5("top_stars_count_5", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedStars(addon, gameModeAddon).exact(4);
        return object != null ? String.valueOf(object.getStarsValue()) : "";
    }),
     ...
     */
    BY_STARS_OWNER_NAME_6("top_stars_owner_name_6", (addon, gameModeAddon, user) -> {
     ...
     */
    BY_STARS_ISLAND_NAME_6("top_stars_island_name_6", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedStars(addon, gameModeAddon).exact(5);
     ...
     */
    BY_STARS_COUNT_6("top_stars_count_6", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedStars(addon, gameModeAddon).exact(5);
        return object != null ? String.valueOf(object.getStarsValue()) : "";
    }),
     ...
     */
    BY_STARS_OWNER_NAME_7("top_stars_owner_name_7", (addon, gameModeAddon, user) -> {
     ...
     */
    BY_STARS_ISLAND_NAME_7("top_stars_island_name_7", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedStars(addon, gameModeAddon).exact(6);
     ...
     */
    BY_STARS_COUNT_7("top_stars_count_7", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedStars(addon, gameModeAddon).exact(6);
        return object != null ? String.valueOf(object.getStarsValue()) : "";
    }),
     ...
     */
    BY_STARS_OWNER_NAME_8("top_stars_owner_name_8", (addon, gameModeAddon, user) -> {
     ...
     */
    BY_STARS_ISLAND_NAME_8("top_stars_island_name_8", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedStars(addon, gameModeAddon).exact(7);
     ...
     */
    BY_STARS_COUNT_8("top_stars_count_8", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedStars(addon, gameModeAddon).exact(7);
        return object != null ? String.valueOf(object.getStarsValue()) : "";
    }),
     ...
     */
    BY_STARS_OWNER_NAME_9("top_stars_owner_name_9", (addon, gameModeAddon, user) -> {
     ...
     */
    BY_STARS_ISLAND_NAME_9("top_stars_island_name_9", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedStars(addon, gameModeAddon).exact(8);
     ...
     */
    BY_STARS_COUNT_9("top_stars_count_9", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedStars(addon, gameModeAddon).exact(8);
        return object != null ? String.valueOf(object.getStarsValue()) : "";
    }),
     ...
     */
    BY_STARS_OWNER_NAME_10("top_stars_owner_name_10", (addon, gameModeAddon, user) -> {
     ...
     */
    BY_STARS_ISLAND_NAME_10("top_stars_island_name_10", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedStars(addon, gameModeAddon).exact(9);
     ...
     */
    BY_STARS_COUNT_10("top_stars_count_10", (addon, gameModeAddon, user) -> {
        LikesObject object = LikesAddonPlaceholderType.getSortedStars(addon, gameModeAddon).exact(9);
        return object != null ? String.valueOf(object.getStarsValue()) : "";
    });
...
// ---------------------------------------------------------------------
    ...
    /**
     * This method returns likes object that referees to given island object. If object does not exist, it creates new
     * empty object.
     *
