...
/**
 * This event is fired when player adds Like to someones island.
 */
public class LikeAddEvent extends BentoBoxEvent
{
// ---------------------------------------------------------------------
// Section: Constructor
// ---------------------------------------------------------------------
     ...
     */
    public LikeAddEvent(UUID user, String islandId)
    {
        this.user = user;
