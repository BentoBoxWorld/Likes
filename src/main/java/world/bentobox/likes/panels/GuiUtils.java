...
// ---------------------------------------------------------------------
    ...
    public static ItemStack getMaterialItem(Material material, int amount)
    {
        ...
        if (material.name().contains("WALL_"))
        {
            ...
            itemStack =
                new ItemStack(Objects.requireNonNull(Material.getMaterial(material.name().replace("WALL_", ""))));
        }
        else if (material.name().startsWith("POTTED_"))
        {
            // Materials Potted elements cannot be in inventory.
            itemStack =
                new ItemStack(Objects.requireNonNull(Material.getMaterial(material.name().replace("POTTED_", ""))));
        }
        ...
        else if (material.equals(Material.END_PORTAL) || material.equals(Material.END_GATEWAY) ||
        ...
        else if (material.equals(Material.AIR) || material.equals(Material.CAVE_AIR) ||
